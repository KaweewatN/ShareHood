...
export default function ItemCardDefault(item: ItemType) {
  return (
    <div className="flex max-h-56 max-w-48 cursor-pointer flex-col justify-evenly rounded-lg border-[1px] p-3 shadow-sm hover:shadow-md md:max-h-60 md:max-w-52">
